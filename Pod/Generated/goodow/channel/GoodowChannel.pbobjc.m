...
@implementation GDCPBGoodowChannelRoot
...
#pragma mark - GDCPBGoodowChannelRoot_FileDescriptor

static GPBFileDescriptor *GDCPBGoodowChannelRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[GDCPBMessage class]
                                     rootClass:[GDCPBGoodowChannelRoot class]
                                          file:GDCPBGoodowChannelRoot_FileDescriptor()
                                        fields:fields
